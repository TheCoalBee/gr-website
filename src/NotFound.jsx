...
function NotFound() {
  return (
    <main id="NotFound">
        <img loading="lazy" className="background" src={"https://grantrax.com.au/wp-content/uploads/2024/12/A-big-grading-project-being-done-before-construction.jpg"}></img>
        ...
        <ContentBlock 
            ...
            imageContent={<img loading="lazy" src="https://grantrax.com.au/wp-content/uploads/2024/12/A-big-grading-project-being-done-before-construction.jpg"/>}
            theme="dark"
          />
