...
function Home() {
  return (
    <main id="home">
        <img loading="lazy" className="background" src="/auto-images/home-bg.webp" alt="" />
        <Hero />
        ...
        <ContentSection>
          <ContentBlock 
            ...
            imageContent={<img loading="lazy" src="/auto-images/home-block1.jpg"/>}
            theme="light"
          />
          <ContentBlock 
            alignment="right" 
            ...
            imageContent={<img loading="lazy" src="/auto-images/home-block2.jpg" />}
            theme="dark"
          />
          <ContentBlock 
            alignment="left" 
            ...
            imageContent={<img loading="lazy" src="/auto-images/home-block3.jpg"/>}
            theme="light"
          />
        </ContentSection>
